...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('countries')->insert([ 
            ...
            ['id' => 27, 'name' => 'Bolivia, Plurinational State of', 'code' => 'BO'],
            ...
            ['id' => 132, 'name' => 'Macedonia, the former Yugoslav Republic of', 'code' => 'MK'],
            ['id' => 133, 'name' => 'Madagascar', 'code' => 'MG'],
            ['id' => 134, 'name' => 'Malawi', 'code' => 'MW'],
            ['id' => 135, 'name' => 'Malaysia', 'code' => 'MY'],
            ['id' => 136, 'name' => 'Maldives', 'code' => 'MV'],
            ['id' => 137, 'name' => 'Mali', 'code' => 'ML'],
            ['id' => 138, 'name' => 'Malta', 'code' => 'MT'],
            ['id' => 139, 'name' => 'Marshall Islands', 'code' => 'MH'],
            ['id' => 140, 'name' => 'Martinique', 'code' => 'MQ'],
            ['id' => 141, 'name' => 'Mauritania', 'code' => 'MR'],
            ['id' => 142, 'name' => 'Mauritius','code' =>  'MU'],
            ['id' => 143, 'name' => 'Mayotte','code' =>  'YT'],
            ['id' => 144, 'name' => 'Mexico','code' =>  'MX'],
            ['id' => 145, 'name' => 'Micronesia, Federated States of','code' =>  'FM'],
            ['id' => 146, 'name' => 'Moldova, Republic of','code' =>  'MD'],
            ['id' => 147, 'name' => 'Monaco','code' =>  'MC'],
            ['id' => 148, 'name' => 'Mongolia','code' =>  'MN'],
            ['id' => 149, 'name' => 'Montenegro','code' =>  'ME'],
            ...
            ['id' => 170, 'name' => 'Palestine, State of','code' =>  'PS'],
            ...
            ['id' => 214, 'name' => 'Swaziland', 'code' => 'SZ'],
            ['id' => 215, 'name' => 'Sweden', 'code' => 'SE'],
            ['id' => 216, 'name' => 'Switzerland', 'code' => 'CH'],
            ['id' => 217, 'name' => 'Syrian Arab Republic','code' =>  'SY'],
            ['id' => 218, 'name' => 'Taiwan, Province of China','code' =>  'TW'],
            ['id' => 219, 'name' => 'Tajikistan', 'code' => 'TJ'],
            ['id' => 220, 'name' => 'Tanzania, United Republic of', 'code' => 'TZ'],
            ...
            ['id' => 238, 'name' => 'Uruguay', 'code' => 'UY'],
            ['id' => 239, 'name' => 'Uzbekistan', 'code' => 'UZ'],
            ['id' => 240, 'name' => 'Vanuatu','code' =>  'VU'],
            ['id' => 241, 'name' => 'Venezuela, Bolivarian Republic of', 'code' => 'VE'],
            ['id' => 242, 'name' => 'Viet Nam', 'code' => 'VN'],
            ['id' => 243, 'name' => 'Virgin Islands, British','code' =>  'VG'],
            ['id' => 244, 'name' => 'Virgin Islands, U.S.','code' =>  'VI'],
            ...
            ['id' => 256, 'name' => 'Scotland','code' =>  'GB'],
            ['id' => 257, 'name' => 'Wales', 'code' => 'GB'],
        ]);
